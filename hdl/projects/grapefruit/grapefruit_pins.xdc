...
set_property -dict { PACKAGE_PIN M1 IOSTANDARD LVCMOS33 } [get_ports { qspi0_hpm_to_scm_dat[3] }];
set_property -dict { PACKAGE_PIN M2 IOSTANDARD LVCMOS33 } [get_ports { qspi0_hpm_to_scm_dat[2] }];
set_property -dict { PACKAGE_PIN K1 IOSTANDARD LVCMOS33 } [get_ports { qspi0_hpm_to_scm_dat[1] }];
set_property -dict { PACKAGE_PIN L1 IOSTANDARD LVCMOS33 } [get_ports { qspi0_hpm_to_scm_dat[0] }];
