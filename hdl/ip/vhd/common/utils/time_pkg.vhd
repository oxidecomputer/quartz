...
package body time_pkg is
    ...
    begin
        return to_integer(calc_us(desired_us, clk_period_ns, 32));
    end;
    ...
    begin
        return to_integer(calc_ms(desired_ms, clk_period_ns, 32));
    end;
    ...
    begin
        return to_integer(calc_ns(desired_ns, clk_period_ns, 32));
    end;
