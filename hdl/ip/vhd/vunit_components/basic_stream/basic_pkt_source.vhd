...
-- basic_source with a last flag, for driving the axi_st_pkt_t flavour of the
-- streaming interface in axist_if_2k19_pkg. Identical backpressure and
-- valid-throttling behaviour, it just carries one more bit.
...
architecture model of basic_pkt_source is
begin
    ...
    begin
        ...
        if msg_type = push_basic_pkt_stream_msg then
            ...
            last    <= '1' when pop_boolean(msg) else '0';
