...
class UDPMem:
    ...
    """
    def __init__(self, target_ip, ifname, target_port=11114, timeout=10):
    ...
    def read32(self, addr):
        """do a 32bit read from the requested address"""
        req = Request()
    ...
    def execute_prebuilt_request(self, req: Request):
        """Allow BYO requests for fancier things"""
        return self._get_resp_from_request(req)

    def _get_resp_from_request(self, request: Request):
        ...
        return request.response.expected_responses

    def _send_get_reply_handshake(self, request: Request):
