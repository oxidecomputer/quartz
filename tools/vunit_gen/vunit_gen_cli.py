...
parser.add_argument('--input', '--inputs', nargs="+", dest='inputs', help='Explicit input file list')
parser.add_argument('--output', dest="output", help="Explicit output list")
#parser.add_argument('--dir', dest="vunit_out", help="Explicit output list")
...
def main():
    ...
    env = Environment(loader=FileSystemLoader(Path(__file__).parent / 'templates'), lstrip_blocks=True, trim_blocks=True)
